...
public class CreatingCampaignAndDeletingCampaignTest extends BaseClass {
	...
	public void CreatingCampaignAndDeletingCampaignTest() throws Throwable {
		...
		// UtilityClassObject.getTest().log(Status.INFO, "campaign page displayed
		// successfully");
		...
		// UtilityClassObject.getTest().log(Status.INFO, "creating campaign page is
		...
		// UtilityClassObject.getTest().log(Status.INFO, "creating information page id
		// displayed successfully");
